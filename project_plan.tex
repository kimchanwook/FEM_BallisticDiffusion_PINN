...
2 & Low-temperature superconducting and nonequilibrium material physics & Serve as the main textbook-style superconductivity and implementation note for the project. Starting from normal-metal electrons, Fermi statistics, phonons, and electron-phonon coupling, derive the Cooper instability, BCS mean-field gap equation, Bogoliubov quasiparticles, equilibrium quasiparticle density, superconducting thermal-property reductions, quasiparticle diffusion, recombination, trapping, photon pair breaking, electron-phonon relaxation, pair-breaking phonons, phonon escape, Rothwarf-Taylor dynamics, and a full FEM derivation chain: strong form, weak form, shape functions, element mass/stiffness/trap/source matrices, nonlinear recombination vectors, global assembly, boundary conditions, implicit time stepping, Newton/Picard solves, and final field reconstruction.\\
...
\texttt{matlab/src/module2\_superconducting/} & BCS gap, equilibrium quasiparticle density, diffusivity, recombination, trap-rate helper functions, and reduced nonequilibrium source/coupling models.\\
